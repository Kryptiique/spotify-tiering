 ...
 * component that will be rendered when a matching route is found. 
 * We want our childProps to be sent to this component.
 *
 ...
 *
 * Based on this we can create a component that returns a Route and takes 
 * a component and childProps prop. This allows us to pass in the component
 * we want rendered and the props that we want applied.
 *
